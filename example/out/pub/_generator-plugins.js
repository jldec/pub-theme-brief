...
module.exports=function(e){var r=(e.opts,e.handlebars);e.util;r.registerHelper("mod",function(e,r){return r.data.index%e||0}),r.registerHelper("box-style",function(e){var r=this["background-image"];return r?"style='background-image:url(\""+escape(r)+"\"); background-size:cover;'":void 0})};
},{}]},{},[2])
